...
# 1. Сделать проверку подписки на телегу у чела.
# 5. Добавить всплывающее окошко "Вы участвуете" (и "Вы уже участвуете", если чел уже нажал эту кнопку (необязательно)). 
# 5. Добавить всплывающее окошко "Подпишись". 
# 6. Сделать так, чтобы форматирование текста сохранялось в посте (необязательно).
# 7. Комманды старт, помощь, создать, редактировать, смотреть-подписку, заканчивать
# можно использовать только внутри чат бота, нельзя в каналах и группах
# 8. можно постить только в каналах и группах только если админ